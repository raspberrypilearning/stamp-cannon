...
function fireVolley(targetX, targetY) {
  // Starting point: place one stamp right where the pointer is.
  addStamp(targetX, targetY, 34, [255, 190, 70], currentShape, 0);

  // TODO 1:
  // Replace the single addStamp(...) call with a for loop.
  // Use stampCount so one click makes many stamps.

  // TODO 2:
  // Use getMuzzlePosition(targetX, targetY) and lerpNum(...)
  // to place the stamps in a line from the cannon to the pointer.

  // TODO 3:
  // Use stampIndex to change the size.

  // TODO 4:
  // Use paletteColour(stampIndex) to change the colour.

  // TODO 5:
  // Use barrelAngle and stampIndex to change the rotation.
}
...
window.addEventListener("keydown", (event) => {
  ...
  // TODO 6:
  // Add keys 1, 2, and 3 so the player can switch between
  // star, square, and flower.
});
